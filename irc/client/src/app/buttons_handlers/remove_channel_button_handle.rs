...
pub fn handle_remove_channel(application: &gtk::Application, client: Arc<Client>) {
    ...
    let send_button = gtk::Button::with_label("Leave Channel");
    ...
    send_button.connect_clicked(move |_| {
        ...
        if !input.is_empty() {
            let msg = ":".to_string() + &client.get_nickname() + " PART #" + &input;
